...
local Gui = Library:AddGui({
	Title = {"Relampago Marquinhos Script", "Made by Vai tomar no cu"},
	ThemeColor = Color3.fromRGB(0,91,150),
	ToggleKey = Enum.KeyCode.RightShift,
})

local Tab = Gui:AddTab("Fodase")

local Category = Tab:AddCategory("Fodase")

local Label = Category:AddLabel("Use a Disgraça do R6")

local Button = Category:AddButton("Ligar Buggati", function()
